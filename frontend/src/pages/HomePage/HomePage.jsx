    ...
    return(
        <div className='home-page'>
            <div className='home-page-stats-container'>
                ...
                <StatsBadge height='100%' width='23%' header='TOTAL P&L' data={`${(currentUserValue >= 10000) ? '+' : '-'}` + '$' + Math.abs((currentUserValue - 10000).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2}))} dataColor={currentUserValue > 10000 ? '#20b657' : 'tomato'} footer={`${currentUserValue > 10000 ? '+' : ''}` + ((currentUserValue - 10000)/100).toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2}) + '%'}/>
